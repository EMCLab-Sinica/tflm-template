...
To add your own models, drop `.tflite` files into `src/models`. The generator will include them on the next `make` and expose per-model entrypoints named `tflm_main_<model_name>`.
